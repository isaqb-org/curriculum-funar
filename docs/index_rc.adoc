...
image:https://img.shields.io/github/commits-since/isaqb-org/curriculum-funar/latest.svg[]
|===
| Version | HTML | PDF
...
- link:https://github.com/isaqb-org/curriculum-funar/blob/main/CHANGELOG.md[CHANGELOG.md on GitHub]
